                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-title"><b>Username: </b><?php echo $row['usuario'] ?></p>
                                            <p class="card-text" name="correo"><b>Correo: </b><?php echo $row['correo'] ?></p>
                                            <input type="submit" name="enviar" id="<?= $row['iduser'] ?>" value="Modificar usuario">
                                        </div>
                                    </div>
                                </div>
                            </form>
