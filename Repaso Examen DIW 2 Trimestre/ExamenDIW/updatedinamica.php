...
?>
        ...
        <body>
            ...
            <div class="container">
                ...
                $query = "select  * from tabladiw WHERE idUser=" . $id;
                ...
                ?>
                        ...
                        <h1 class="mt-5 text-success">Editar usuario</h1>
                        <hr>
                        <form class="mt-5 col-md-6" action="updatedinamica2.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" name="correo" class="form-control" id="correo" placeholder="<?= $row["correo"] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 col-form-label"><b>Nombre</b></label>
                                <div class="col-sm-10">
                                    <input type="text" name="nombre" class="form-control" id="nombre" placeholder="<?= $row["nombre"] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 col-form-label"><b>Apellidos</b></label>
                                <div class="col-sm-10">
                                    <input type="text" name="apellidos" class="form-control" id="apellidos" placeholder="<?= $row["apellidos"] ?>">
                                </div>
                            </div>
                            <hr>
