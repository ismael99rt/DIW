        ...
        <body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <!-- Selección múltiple -->
                    <form action="selecciondinamica.php" method="post">
                        <p><b>Productos</b></p>
                        Raquetas:<input type="radio" name="idCategoria" value="1"><br>
                        Pelotas:<input type="radio" name="idCategoria" value="2"><br>
                        Deportes:<input type="radio" name="idCategoria" value="3"><br>
                        Camisetas:<input type="radio" name="idCategoria" value="4"><br>
                        Equipaje:<input type="radio" name="idCategoria" value="5"><br>
                        <hr>
                        <p><b>Precio</b></p>
                        > 50 euros:<input type="radio" name="precio" value="50"><br>
                        > 70 euros:<input type="radio" name="precio" value="70"><br>
