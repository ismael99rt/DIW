        ...
        <body>
            ...
            <div class="container-fluid mt-5">
                ...
                <form action="eliminaregistros.php" method="post">
                        ...
                        ?>
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        <input type="checkbox" class="card-title" name="tenis[]" value="<?php echo $row['idProducto'] ?>"><?php echo $row['nombreProducto'] ?></input>
                    ...
                    <hr>
                    <div class="row justify-content-center text-center"><input type="submit" name="enviar" value="Borrar" class="btn btn-primary" /></div>
                </form>
            </div>
            </div>
            <!-- Selección múltiple -->
