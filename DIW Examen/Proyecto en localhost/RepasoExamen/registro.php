		...
		<div class="login-wrap">
			...
			<div class="login-form">
                ...
                <div class="group">
						...
						<input id="user" type="text" class="input" name="usernick" required>
					</div>
					<div class="group">
						<label for="pass" class="label">Contraseña</label>
						<input id="pass" type="password" class="input" data-type="password" name="password1" required>
					</div>
					<div class="group">
						<label for="pass" class="label">Contraseña</label>
					...
					<div class="group">
						...
						<input id="pass" type="text" class="input" name="email1" required>
					</div>
					<div class="group">
						<label for="pass" class="label">Correo electrónico confirmación</label>
						<input id="pass" type="text" class="input" name="email2" required>
					</div>
					<div class="group">
