    ...
    if($_SESSION["perfil"]=="admin"){
        ...
        <div class="row slider align-items-center justify-content-center">
            <div class="col-8 bg-success">
                <p>Esto es una página de inicio del administrador, en donde podrá realizar una serie de eventos de mantemiento: Consultar, modificar, y dar de alta a un usuario.</p>
            </div>
        </div>
        <div class="row">
