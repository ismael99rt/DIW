        ...
        <body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    if (isset($_POST['idCategoria1'])) {
                        $idCategoria = $_POST['idCategoria1'];
                        $clauses[] = 'categoria = "' . $idCategoria . '"';
                    }
                    if (isset($_POST['idCategoria2'])) {
                        $idCategoria = $_POST['idCategoria2'];
                        $clauses[] = 'categoria = "' . $idCategoria . '"';
                    }
                    if (isset($_POST['idCategoria3'])) {
                        $idCategoria = $_POST['idCategoria3'];
                        $clauses[] = 'categoria = "' . $idCategoria . '"';
                    }
                    ...
                    if (count($clauses) > 0) {
                        $query .= ' WHERE ' . implode(' OR ', $clauses) . ' AND precio >=' . $precio . ';';
                    }
                            ...
                            ?>
                                <div class="col-12 col-sm-6 col-md-3 mt-5">
                                    <div class="card" style="width: 18rem;">
                                        <div class="card-body">
                                            <a class="card-title"><b>ID Producto:</b> <?php echo $row['id'] ?></a><br>
                                            <b class="card-title text-success"><?php echo $row['nombre'] ?></b>
