...
?>
        ...
        <body>
            ...
            <div class="container-fluid mt-5">
                ...
                <!-- Selección múltiple -->
                <form action="eliminaregistros.php" method="post">
                        ...
                        ?>
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body">
                                        <input type="checkbox" class="card-title" name="tenis[]" value="<?php echo $row['id'] ?>"><b><?php echo $row['nombre'] ?></b></input>
                                        <p class="card-text"><b>Descripcion: </b><?php echo $row['descripcion'] ?></p>
                                        <p class="card-text"><b>Fabricante: </b><?php echo $row['nombre_fabricante'] ?></p>
                                        <p class="card-text text-success"><b>Precio: </b><?php echo $row['precio'] ?> euros</p>
                                    </div>
                                </div>
                            </div>
                        <?php
                    ...
                    <hr>
                    <div class="row justify-content-center text-center"><input type="submit" name="enviar" value="Borrar" class="btn btn-danger" /></div>
                </form>
            </div>
            </div>
            <!-- Selección múltiple -->
            ...
            <div class="mt-5 container">
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        ...
                        ?>
                            <li class="page-item"><?= '<a class="page-link" href = "seleccionmultiple.php?page=' . $page . '">' . $page . ' </a>'; ?></li>
                        <?php
                        }
                        ?>
                    </ul>
